    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between position-relative">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">All Folders</h3>
            </div>
            <div class="nk-block-head-content">
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style="">
                                <ul class="link-list-opt no-bdr">
                                    <li><a href='/assignfolder/{{$folder->id ?? 1}}'><em class="icon ni ni-folder-plus"></em><span>Assign Folder</span></a></li>
                                    <li><a href="#" data-toggle="modal" data-target="#exampleModalCenter"><em class="icon ni ni-folder-plus"></em><span>Create Folder</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
                ...
                <div class="nk-files-list">
                    ...
                    <div class="nk-file-item nk-file">
                        <div class="nk-file-info">
                            <a href="/adminfile/{{ $folder->id }}" class="nk-file-link">
                                <div class="nk-file-title">
                                    ...
                                    <div class="nk-file-name">
                                        <div class="nk-file-name-text">
                                            <span href="/adminfile/{{ $folder->id }}" class="title">{{ $folder->name }}</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="nk-file-actions hideable">
                            <a id='delete_folder' data-id='{{$folder->id}}' data-name='{{ $folder->name }}' class="btn btn-sm btn-icon btn-trigger"><em class="icon ni ni-cross"></em></a>
                        </div>
                    </div>
                    @endforeach
                </div>
