...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/dark/apps/file-manager/folders.html?page=apps/file-manager/files/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 13:20:03 GMT -->
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="https://preview.keenthemes.com/metronic8/demo1/dark/index.html" class="d-lg-none">
									...
									<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3" href="https://preview.keenthemes.com/metronic8/demo1/dark/index.html">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-muted">
											<a href="https://preview.keenthemes.com/metronic8/demo1/dark/index.html" class="text-muted text-hover-primary">Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
																...
																<div
																	...
																	<div class="d-flex align-items-center">
																		...
																		<div class="fs-2 fw-bolder" data-kt-countup="true"
																			...
																			data-kt-countup-prefix="">{{ count(App\User::all()) }}</div>
																	</div>
																	<!--end::Number-->
																	<!--begin::Label-->
																...
																<div
																	...
																	<div class="d-flex align-items-center">
																		...
																		<div class="fs-2 fw-bolder" data-kt-countup="true"
																			...
																			data-kt-countup-value="">{{ count(App\Test::all()) }}</div>
																	</div>
																	<!--end::Number-->
																	<!--begin::Label-->
																...
																<div
																	...
																	<div class="d-flex align-items-center">
																		...
																		<div class="fs-2 fw-bolder" data-kt-countup="true"
																			...
																			data-kt-countup-prefix="">{{ count(App\Schedule::all()) }}</div>
																	</div>
																	<!--end::Number-->
																	<!--begin::Label-->
								...
								<div class="card card-flush">
									...
									<!--begin::Card body-->
									<div class="card-body">
										@include('dashboard.folderpagination')
									</div>
									<!--end::Card body-->
								</div>
								<!--end::Card-->
								...
								<table class="d-none">
									<tr id="kt_file_manager_new_folder_row" data-kt-filemanager-template="upload">
										...
										<td id="kt_file_manager_add_folder_form" class="fv-row">
											<form method='post' id='createfolder'  enctype="multipart/form-data">@csrf
												<div class="d-flex align-items-center">
													<!--begin::Folder icon-->
													...
													<!--end::Folder icon-->
													<!--begin:Input-->
													<input type="text" required name="name" id='name' placeholder="Enter the folder name" class="form-control mw-250px me-3" />
													<!--end:Input-->
													<!--begin:Submit button-->
													<button id='create_folder' class="btn btn-icon btn-light-primary me-3" type='submit'>
								...
								<div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
									...
									<div class="modal-dialog modal-dialog-centered mw-650px">
										...
										<div class="modal-content">
											<!--begin::Form-->
											<form class="form" action="https://preview.keenthemes.com/metronic8/demo1/dark/apps/file-manager/none" id="kt_modal_upload_form">
												<!--begin::Modal header-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" target="_blank" class="text-gray-800 text-hover-primary">Crown</a>
							</div>
		...
		<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div class="card shadow-none rounded-0">
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
				...
				<div class="card-footer py-5 text-center" id="kt_activities_footer">
					<a href="https://preview.keenthemes.com/metronic8/demo1/dark/pages/profile/activity.html" class="btn btn-bg-body text-primary">View All Activities 
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<img alt="Logo" src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Invite Gmail Contacts</div>
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/card-logos/dark/visa.svg" alt="" class="h-25px" />
														<img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/card-logos/dark/mastercard.svg" alt="" class="h-25px" />
														<img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/card-logos/dark/american-express.svg" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/dark/apps/file-manager/folders.html?page=apps/file-manager/files/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 13:20:26 GMT -->
</html>