...
<body id="kt_body"
				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
							...
							<div class="menu-item">
								<a class="menu-link active" href="/adminfolder">
									<span class="menu-icon">
						...
						<div id="kt_content_container" class="container-xxl">
											...
											<div
												...
												<div class="d-flex my-4">
													<a href="#" data-bs-toggle="modal"
														...
														class="btn btn-sm btn-success">Update Profile</a>
													...
													<div class="d-flex flex-wrap">
														...
														<div
															...
															<div class="d-flex align-items-center">
																...
																<div class="fs-2 fw-bolder" data-kt-countup="true"
																	data-kt-countup-value="{{ count(App\User::all()) }}"
																	data-kt-countup-prefix="">{{ count(App\User::all())
																	}}</div>
															</div>
															<!--end::Number-->
															<!--begin::Label-->
														...
														<div
															...
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<div class="fs-2 fw-bolder" data-kt-countup="true"
																	data-kt-countup-value="{{ count(App\Test::all()) }}"
																	data-kt-countup-value="">{{ count(App\Test::all())
																	}}</div>
															</div>
															<!--end::Number-->
														...
														<div
															...
															<div class="d-flex align-items-center">
																...
																<!--end::Svg Icon-->
																<div class="fs-2 fw-bolder" data-kt-countup="true"
																	data-kt-countup-value="{{ count(App\Schedule::all()) }}"
																	data-kt-countup-prefix="">{{
																	count(App\Schedule::all()) }}</div>
															</div>
															<!--end::Number-->
															<!--begin::Label-->
							...
							<div class="card card-flush">
								...
								<div class="card-body" id='table_data'>
									@include('dashboard.filepagination')
									<!--end::Table-->
								</div>
								<!--end::Card body-->
							</div>
									...
									<div class="modal-content">
										...
										<div class="modal-body pt-10 pb-15 px-lg-17">
											...
											<div class="form-group">
												<form method='post' action='{{route("createfile",[$folder->id])}}'
	...
	<script>
		var oTable = $('#filetable').DataTable();   //using Capital D, which is mandatory to retrieve "api" datatables' object, latest jquery Datatable
$('#myInput').keyup(function(){
	...
	<script>
		...
		$.ajax({
		url:"{{ route('filepagination',[$folder->id]) }}",
		method:"POST",
