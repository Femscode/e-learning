        ...
        <div class="card">
            ...
            <div class="card-body pb-0">
                ...
                <a href="#" class="btn btn-primary float-right " data-bs-toggle="modal"
                    data-bs-target="#kt_modal_new_address">Create New Test</a>

                <div class="card-body py-3" id='table_data'>
                    @include('dashboard.testpagination')
                </div>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true"
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input minlength="8" required class="form-control form-control-solid" placeholder=""
                                        name="description" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type='number' class="form-control form-control-solid" placeholder=""
                                        name="minutes" />
                                    <!--end::Input-->
                                </div>
...
<script>
    var oTable = $('#testtable').DataTable();   //using Capital D, which is mandatory to retrieve "api" datatables' object, latest jquery Datatable
