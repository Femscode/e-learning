														...
														<div class="d-flex flex-wrap">
															...
															<div
																...
																<div class="d-flex align-items-center">
																	...
																	<!--end::Svg Icon-->
																	<div class="fs-2 fw-bolder" data-kt-countup="true"
																		data-kt-countup-value="{{ count(App\Test::all()) }}">0{{ count(App\Test::all()) }}</div>
																</div>
																<!--end::Number-->
																<!--begin::Label-->
...
<script>
var oTable = $('#kt_file_manager_list').DataTable();   //using Capital D, which is mandatory to retrieve "api" datatables' object, latest jquery Datatable
