...
<body id="kt_body"
				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
							...
							<div class="menu-item">
								<a class="menu-link active" href="/userfolder">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/layouts/lay010.svg-->
										<span class="svg-icon svg-icon-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="card card-flush">
								...
								<div class="card-body">
									...
									<!--end::Table header-->
									<!--begin::Table-->
									<table id="foldertable" data-kt-filemanager-table="folders"
												...
												<td class="text-end" data-kt-filemanager-table="action_dropdown">
													<div class="d-flex justify-content-end">
														...
														<div class="ms-2" data-kt-filemanger-table="copy_link">
															...
															<a id='detach_folder' data-user='{{$user->id}}'
																data-folderName='{{ $folder->name }}'
																data-folder='{{ $folder->id }} ' type="button"
											...
											<tr>
												...
												<td data-order="landing.html">
													<div class="d-flex align-items-center">
														...
														<!--end::Svg Icon-->
														<a href="/metronic8/demo1/../demo1/dark/apps/file-manager/files/.html"
															class="text-gray-800 text-hover-primary">{{$file->name}}</a>
													</div>
												</td>
												...
												<td class="text-end" data-kt-filemanager-table="action_dropdown">
													<div class="d-flex justify-content-end">
														<!--begin::Share link-->
														<div class="ms-2" data-kt-filemanger-table="copy_link">
															<a id='detach_file' data-user='{{$user->id}}'
																data-folderName='{{ $file->name }}'
																data-folder='{{ $file->id }} '
																class="btn btn-sm btn-icon btn-danger btn-active-light-primary"
																data-kt-menu-trigger="click"
																data-kt-menu-placement="bottom-end">
																<!--begin::Svg Icon | path: icons/duotune/coding/cod007.svg-->
																<span class="svg-icon svg-icon-5 m-0">
		...
		$('body').on('click', '#delete_question', function () {
			...
			async function resetAccount(el,id,name) {
					const willUpdate = await swal({
						...
						text: `Are you sure you want to delete the question: `+name+` ?`,
						icon: "warning",
					...
					if (willUpdate) {
						...
						swal("The question:"+ name + " will not be deleted  :)");
					}
				}
	...
	<script>
		var oTable = $('#foldertable').DataTable();   //using Capital D, which is mandatory to retrieve "api" datatables' object, latest jquery Datatable
			...
			$('body').on('click', '#delete_folder', function () {
				...
				async function resetAccount(el,id) {
						...
						if (willUpdate) {
							...
							swal("Folder will not be deleted  :)");
						}
					}
