            ...
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick= 'return confirm("Are you sure you want to mark done")' href='/markschedule/{{$schedule->id}}'class='btn btn-success btn-sm'>Mark Done</a>
                            <a onclick= 'return confirm("Are you sure you want to unmark done")' href='/unmarkschedule/{{$schedule->id}}'class='btn btn-info btn-sm'>unmark</a>
                            <a onclick= 'return confirm("Are you sure you want to Delete this Schedule")' href='/deleteschedule/{{$schedule->id}}'class='btn btn-danger btn-sm'>Delete</a>
                                    ...
                                    <div class="fv-row mb-15" data-kt-buttons="true">
                                        ...
                                        <label
                                            ...
                                            <input class="btn-check" type="radio"
                                                checked="checked" name="project_type"
                                                value="1" />
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                            <span class="d-flex">
                                                ...
                                                <span class="ms-4">
                                                    <span
                                                        ...
                                                        Project</span>
                                                    <span
                                                        class="fw-bold fs-4 text-muted">If
                                        ...
                                        <label
                                            ...
                                            <span class="d-flex">
                                                ...
                                                <span class="ms-4">
                                                    <span
                                                        class="fs-3 fw-bolder text-gray-900 mb-2 d-block">Team
                                                        Project</span>
                                                    <span
