        ...
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Projects</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="taskboard.html">Taskboard</a></li>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>New Schedule</strong></h2>
                                ...
                                <ol class="dd-list">
                                    ...
                                    <li class="dd-item" data-id="1">
                                        <div class="dd-handle d-flex justify-content-between align-items-center">
                                            <div class="h6 mb-0">{{$task->schedule_title}}</div>
                                           
                                        </div>
                                        <div class="dd-content p-15">
                                            <p>{{$task->schedule_description}}</p>
                                            <ul class="list-unstyled d-flex bd-highlight align-items-center">
                                                <li class="mr-2 flex-grow-1 bd-highlight"><span class="badge badge-danger">Not done</span></li>
                                                 <li class="ml-3 bd-highlight">
                                                    <a href='/pendschedule/{{$task->id}}' class='btn btn-sm btn-success'>✔</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                ...
                                <ol class="dd-list">
                                    ...
                                    <li class="dd-item" data-id="1">
                                        ...
                                        <div class="dd-content p-15">
                                            <p>{{$task->schedule_description}}</p>
                                            <ul class="list-unstyled d-flex bd-highlight align-items-center">
                                                <li class="mr-2 flex-grow-1 bd-highlight"><span class="badge badge-warning">Pending</span></li>
                                ...
                                <ol class="dd-list">
                                    ...
                                    <li class="dd-item" data-id="1">
                                        ...
                                        <div class="dd-content p-15">
                                            <p>{{$task->schedule_description}}</p>
                                            <ul class="list-unstyled d-flex bd-highlight align-items-center">
                                                <li class="mr-2 flex-grow-1 bd-highlight"><span class="badge badge-success">Done</span></li>
...
<script src="{{asset('assets/jquerycountdown/dist/jquery.countdown360.min.js')}}"></script></body>
</html>