        ...
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Blog</span></a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="blog-grid.html">Grid View</a></li>
                            ...
                            <div class="blogitem-content">
                                <div class="blogitem-header">
                                    <div class="blogitem-meta">
                                        ...
                                        <span><i class="zmdi zmdi-app"></i><a href="blog-details.html">Number of questions:{{$test->questions->count()}}</a></span>
                                    </div>
                                </div>
                                <h5><a href="blog-details.html">{{$test->name}}</a></h5>
