...
-->
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
                                ...
                                <div class="card card-flush">
									...
									<div class="card-body">
										<!--begin::Form-->
										<form method='post' action='{{route("assigndocument")}}'>@csrf
											...
											<div class="fv-row row mb-15">
												...
												<div class="col-md-9">
													...
													<div class="form-check form-switch form-check-custom form-check-solid me-10">
														<input class="form-check-input h-30px w-50px" name="alluser" type="checkbox" value="" id="autotimezone">
											...
											<div class="fv-row row mb-15">
												...
												<div class="col-md-9">
													<!--begin::Input-->
													<select name='userId[]' multiple = 'multiple' aria-label="Select Users" data-control="select2" data-placeholder="Select Users..." class="form-select mb-2 select2-hidden-accessible" data-select2-id="select2-data-10-t0j8" tabindex="-1" aria-hidden="true">
											...
											<div class="fv-row row mb-15">
												...
												<div class="col-md-9">
													<!--begin::Input-->
													<select name="documentId[]" multiple='multiple' aria-label="Select multiple documents to assign to users" data-hide-search="true" data-control="select2" data-placeholder="Select multiple documents to assign to users" class="form-select mb-2 select2-hidden-accessible" data-select2-id="select2-data-13-118z" tabindex="-1" aria-hidden="true">
		...
		<script src="{{asset('folderasset/plugins/custom/datatables/datatables.bundle.js')}}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{asset('folderasset/js/custom/apps/file-manager/list.js')}}"></script>
