							...
							<div id="kt_content_container" class="container-xxl">
												...
												<tr>
													...
													<td data-order="account">
														<div class="d-flex align-items-center">
															...
															<a href="/listuserdocument/{{$user->id}}">
															...
															<!--end::Svg Icon-->
															<a href="/listuserdocument/{{$user->id}}" class="text-gray-800 text-hover-primary">{{$user->name}}</a>
														</div>
													</td>
													<!--end::Name=-->
													<!--begin::Size-->
								...
								<div class="d-none" data-kt-filemanager-template="action">
									<div class="d-flex justify-content-end">
										...
										<!--begin::More-->
										<div class="ms-2">
											<a href='/assignfolder/{{$user->id}}'  class="btn btn-sm btn-icon btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
												<!--begin::Svg Icon | path: icons/duotune/general/gen052.svg-->
												<span class="svg-icon svg-icon-5 m-0">
													<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														<rect x="10" y="10" width="4" height="4" rx="2" fill="black" />
