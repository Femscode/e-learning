            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <a onclick="return confirm('Are you sure you want to delete this test?')"  href="{{route('test.destroy',[$test->id])}}" class="btn btn-danger btn-sm">
                            <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                            Delete
                        </a>
        ...
        <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{route('test.store')}}" method="POST" enctype="multipart/form-data">@csrf
                        <!--begin::Modal header-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-bold">
                                            ...
                                            <div class="fs-6 text-gray-700">Create Test For Users</div>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                                    <!--end::Wrapper-->
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required class="form-control form-control-solid" placeholder="" name="name" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input minlength="8" required class="form-control form-control-solid" placeholder="" name="description" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input required type='number' class="form-control form-control-solid" placeholder="" name="minutes" />
                                    <!--end::Input-->
                                </div>
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type='file' accept='image/*' class="form-control form-control-solid" placeholder="" name="image" />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::Scroll-->
