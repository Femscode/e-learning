                                ...
                                <div class="d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                            ...
                                            <img src="public/agent/{{Auth::user()->profilePic}}" alt="profilePic" />
                                        </div>
                                        <!--begin::Menu-->
                                                    ...
                                                    <span class="menu-title position-relative">Language
                                                        <span
                                                            ...
                                                            <img class="w-15px h-15px rounded-1 ms-2"
                                                                src="public/agent/{{Auth::user()->profilePic}}"
                                                ...
                                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="/agent/{{Auth::user()->profilePic}}"
                                                                    alt="metronic" />
                                                            </span>German</a>
                                                    </div>
                                                    <!--end::Menu item-->
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div id="kt_content_container" class="container">
                                ...
                                <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                    ...
                                    <div class="me-7 mb-4">
                                        <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                            <img src="public/agent/{{Auth::user()->profilePic}}" alt="image" />
                                            <div
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <a href="/{{Auth::user()->username}}"
                                                        ...
                                                        >cthostel.com/{{Auth::user()->username}}</a>
                                                </div>
                                                <!--end::Name-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                                    <a href="#"
                                                        ...
                                                        <!--end::Svg Icon-->{{Auth::user()->type}}
                                                    </a>
                                                    <a href="#"
                                                        class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                                        <!--begin::Svg Icon | path: icons/duotone/Map/Marker1.svg-->
                                                      
                                                        <!--end::Svg Icon-->{{ Auth::user()->school->name }}
                                                    </a>
                                                    <a href="#"
													...
													<div class="modal-content rounded">
														...
														<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
															...
															<form id="updateProfile" class="form">
																...
																<input type='hidden' id='profileId' value="{{Auth::user()->id}}">
																<div class="d-flex flex-column mb-8 fv-row">
																	...
																	<!--end::Label-->
																	<input type="text" required class="form-control form-control-solid" id='profilename' value='{{Auth::user()->username}}' name="name" />
																</div>
																<div class="d-flex flex-column mb-8 fv-row">
																	<!--begin::Label-->
																	<label class="d-flex align-items-center fs-6 fw-bold mb-2">
																	...
																	<!--end::Label-->
																	<input type="text" class="form-control form-control-solid" id='profileemail'  value='{{Auth::user()->email}}' name="email" />
																</div>
																<div class="d-flex flex-column mb-8 fv-row">
																	<!--begin::Label-->
																	<label class="d-flex align-items-center fs-6 fw-bold mb-2">
																	...
																	<!--end::Label-->
																	<input required type="text" class="form-control form-control-solid" id='profilephone' value='{{Auth::user()->phone}}' name="phone" />
																</div>
																<div class="d-flex flex-column mb-8 fv-row">
																	<!--begin::Label-->
																	<label class="d-flex align-items-center fs-6 fw-bold mb-2">
																	...
																	<!--end::Label-->
																	<input accept="image/png,image/jpg, image/jpeg" required type="file" class="form-control form-control-solid" id='profilePic'  name="profilePic" />
																</div>
                                            ...
                                            <div class="d-flex my-4">
                                                ...
                                                <a href="/" class="btn btn-sm btn-dark me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">My Profile</a>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="fs-2 fw-bolder" data-kt-countup="true"
                                                                data-kt-countup-value="{{count($album)}}">
                                                                0</div>
                                                        </div>
                                                        <!--end::Number-->
                                                        <!--begin::Label-->
                                    ...
                                    <div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                <!--begin::Form-
                                                <form method='post'  id='create_hostel_form' enctype="multipart/form-data">@csrf
                                            --><form method='post' action="{{route('album.storewithroute')}}"  enctype="multipart/form-data">@csrf
                                                    <!--begin::Modal header-->
                                                    ...
                                                    <div class="modal-body py-10 px-lg-17">
                                                        ...
                                                        <div class="scroll-y me-n7 pe-7"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex flex-stack flex-grow-1">
                                                                    ...
                                                                    <div class="fw-bold">
                                                                        ...
                                                                        <div class="fs-6 text-gray-700">Please input a
                                                                            very friendly price while creating hostel,
                                                                            this will help us for getting you customers
                                                                            frequently
                                                                            <a href="#"></a>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input required class="form-control form-control-solid" id='desc'
                                                            ...
                                                            <div class="d-flex flex-column mb-5 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input accept="image/*" required class="form-control form-control-solid"
                                                                    id='image' type='file'
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        ...
                                        <tbody>
                                            @foreach ($album as $index => $album)
                                                ...
                                                <td>
                                                    <img src="public/hostelimage/{{$album->image}}"
                                                ...
                                                <td>@if($album->status == 1)
                                                    ...
                                                    <a href='/cthostel/{{$album->slug}}/{{$album->id}}'
                                                ...
                                                <td>
										<a id='upload_image_id' data-bs-toggle="modal" data-id='{{$album->id}}' data-bs-target="#kt_modal_create_api_key" class="btn btn-icon btn-bg-dark btn-color-primary btn-sm me-1">
										  {{-- <a href="{{ Route('upload.album', [$album->id]) }}"
													...
													<div class="modal fade" id="kt_modal_create_api_key" tabindex="-1" aria-hidden="true">
														...
														<div class="modal-dialog modal-dialog-centered mw-650px">
															...
															<div class="modal-content">
																...
																<form action="{{route('uploadImagewithroute')}}" enctype="multipart/form-data" class="form" method="post">@csrf
																	<!--begin::Modal body-->
																	<div class="modal-body py-10 px-lg-17">
																		<!--begin::Scroll-->
																		<div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_api_key_header" data-kt-scroll-wrappers="#kt_modal_create_api_key_scroll" data-kt-scroll-offset="300px">
																			...
																			<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-10 p-6">
																				...
																				<div class="d-flex flex-stack flex-grow-1">
																					...
																					<div class="fw-bold">
																						...
																						<div class="fs-6 text-gray-700">It is advisable to upload three(3) images at a time for fast upload. 
																						</div>
																					</div>
																					<!--end::Content-->
																				</div>
																			...
																			<div class="mb-5 fv-row">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type='hidden' name='hostel_id' id='hostelimage' value='{{$album->id}}' >
																				<input required accept="image/png,image/jpg, image/jpeg" type="file" multiple class="form-control form-control-solid" id='upload_file' name='hostelimage[]' placeholder="kitchen, toilet, room e.t.c"  />
																				<!--end::Input-->
																			</div>
                                                                    ...
                                                                    <div class='mb-5 fv-row'>
                                                                        ...
                                                                        <div style='padding: 15px 15px 15px 15px;margin: 20px 20px 20px 20px;background: #fff;overflow: visible;position: relative;' id='uploadedimagediv'>
                                                                           </div>
                                                ...
                                                <td>
                                                    <a href="#" data-id='{{ $album->id }}' id='edit_hostel'
                                                        class="btn btn-icon btn-bg-light btn-color-primary btn-sm me-1"
                                                        data-bs-toggle="modal" data-bs-target="#kt_modal_new_target2">

                                                        {{-- <a href='{{Route("edit.album",[$album->id])}}' class="btn btn-icon btn-bg-light btn-color-primary btn-sm me-1"> --}}
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <path
													...
													<input type='hidden' value='{{Auth::user()->school_id}}' id='sch_id'/>
                                                </td>
                                                <div class="modal fade" id="kt_modal_new_target2" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                                        ...
                                                        <div class="modal-content rounded">
                                                            ...
                                                            <div class="modal-header" style id="kt_modal_new_address_header">
                                                                <!--begin::Modal title-->
                                                                <h2>Edit Hostel</h2>
                                                            
                                                            </div>
                                                           
                                                            <form id='update_hostel'
                                                                    ...
                                                                    <div class="scroll-y me-n7 pe-7"
                                                                        ...
                                                                        <div class="row mb-5">
                                                                            ...
                                                                            <div class="col-md-6 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--end::Input-->
                                                                                <input required type="number" id='edit_price' name='price'
                                                                                    class="form-control form-control-solid"
                                                                                    placeholder="" />
                                                                                <!--end::Input-->
                                                                            </div>
                                                                        ...
                                                                        <div class="d-flex flex-column mb-5 fv-row">
                                                                            ...
                                                                            <!--begin::Input-->
                                                                            <input required
                                                                                class="form-control form-control-solid" id='edit_desc'
                                                                                placeholder="Hostel description"
                                                                                name="description" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                                        ...
                                                                        <div class="d-flex flex-column mb-5 fv-row">
                                                                            <!--begin::Label-->
                                                                            <label
                                                                                class="required fs-5 fw-bold mb-2">Hostel
                                                                                Image</label>
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input accept="image/png,image/jpg, image/jpeg" required
                                                                                class="form-control form-control-solid"
                                                ...
                                                <td>
                                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                                        <!--begin::Input-->
                                                        <input class="status_id form-check-input" data-id='{{$album->id}}' name="github" type="checkbox" value="1"  @if($album->status == 1)checked='checked'@else @endif>
                                                       
                                                    </label>
                                                </td>
                                                <td>
                                                <a class='fa fa-map-marker fa-2x' href='{{route("address",[$album->id])}}'>
                                                      
                                               </a>
                                                </td>
                                                <td>
                                                    {{-- <form action="{{ Route('destroy.album', [$album->id]) }}" --}}
                                                    <form id='delete_hostel' data-id="{{$album->id}}"
                                                        class="btn btn-icon btn-bg-light btn-color-danger btn-sm">
                                                        @csrf
                                                        {{ method_field('delete') }}
														<input type='hidden' id='delete_id' value='{{$album->id}}'>
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">My Projects</span>
                                </h3>
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    {{-- <a href="{{route('album.create')}}"> --}}
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">
                                        ...
                                        <button type="button" class="btn btn-sm btn btn-primary">
                                            ...
                                            Upload Project you've worked on
                                            <!--end::Svg Icon-->
                                        </button>
                                    </a>
                                    <!--begin::Menu 2-->
                                                        ...
                                                        <div class="scroll-y me-n7 pe-7"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex flex-stack flex-grow-1">
                                                                    <!--begin::Content-->
                                                                    <div class="fw-bold">
                                                                        <h4 class="text-gray-900 fw-bolder">Tips</h4>
                                                                        <div class="fs-6 text-gray-700">
                                                                            Showcase projects/designs/works that you will like your customers to see.
                                                            ...
                                                            <div class="row mb-5">
                                                                ...
                                                                <div class="col-md-6 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fs-5 fw-bold mb-2">Title</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input required type="text" id='name' name='name'
                                                                        class="form-control form-control-solid"
                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        ...
                                        <tbody>
                                            @foreach ($project as $index => $album)
                                                <th scope="row">{{ $index + 1 }}</th>
                                                
                                                <td> {{ $album->title }}<a href=""></a> </td>
                                                <td> {{ $album->description }}</td>
                                                ...
                                                <td>
										<a id='upload_project_id' data-bs-toggle="modal" data-id='{{$album->id}}' data-bs-target="#kt_modal_create_api_key" class="btn btn-icon btn-bg-dark btn-color-primary btn-sm me-1">
										  {{-- <a href="{{ Route('upload.album', [$album->id]) }}"
                                                        class="btn btn-icon btn-bg-light btn-color-info btn-sm me-1"> --}}
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="modal fade" id="kt_modal_create_api_key" tabindex="-1" aria-hidden="true">
														...
														<div class="modal-dialog modal-dialog-centered mw-650px">
															...
															<div class="modal-content">
																...
																<!--begin::Form-
																<form id="kt_modal_create_api_key_form" class="form" action="#">-->
																<form action="{{route('uploadserviceimage',[$album->id])}}" enctype="multipart/form-data" class="form" method="post">@csrf
																	<!--begin::Modal body-->
																	<div class="modal-body py-10 px-lg-17">
																		<!--begin::Scroll-->
																		<div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_api_key_header" data-kt-scroll-wrappers="#kt_modal_create_api_key_scroll" data-kt-scroll-offset="300px">
																			...
																			<div class="mb-5 fv-row">
																				...
																				<!--end::Label-->
																				<!--begin::Input-->
																				<input type='hidden' name='project_id' id='project_id' value='{{$album->id}}' >
																				<input type='hidden' name='hostel_id' id='projectimage' value='{{Auth::user()->id}}' >
																				<input required accept="image/png,image/jpg, image/jpeg" type="file" multiple class="form-control form-control-solid" id='upload_file' name='projectimage[]' placeholder="kitchen, toilet, room e.t.c"  />
																				<!--end::Input-->
																			</div>
                                                ...
                                                <td>
                                                    <a href="#" data-id='{{ $album->id }}' id='edit_project'
                                                        class="btn btn-icon btn-bg-light btn-color-primary btn-sm me-1"
                                                        data-bs-toggle="modal" data-bs-target="#kt_modal_new_target2">
                                                                    ...
                                                                    <div class="scroll-y me-n7 pe-7"
                                                                        ...
                                                                        <div class="row mb-5">
                                                                            ...
                                                                            <div class="col-md-6 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--begin::Input-->
                                                                                <input required type="text" name='title' id='edit_name'
                                                                                    class="form-control form-control-solid"
                                                                                    placeholder="" />
                                                                                <input type='hidden' id='id' value=''>
                                                ...
                                                <td>
                                                    ...
                                                    <form id='delete_project' data-id="{{$album->id}}"
                                                        class="btn btn-icon btn-bg-light btn-color-danger btn-sm">
                                                        @csrf
                                                        {{ method_field('delete') }}
														<input type='hidden' id='delete_id' value='{{$album->id}}'>
    ...
    <script>
        $(document).ready(function() {
				   ...
				   $("#create_hostel_form").submit(async function(e) {
                       e.preventDefault()
                            ...
                            $.ajax({
                                ...
                                processData: false,
                                success: (data) => {
                                    swal("Success", 'Hostel created successfully', 'success');
                                    console.log(data)
                                ...
                                error: function(data) {
                                    console.log(data);
                                    swal('Oops', 'Hostel not created, Image size too big','error')
                                }
                            });
						});
                ...
                $("#kt_modal_new_address_submit").attr('disabled',true)
                            ...
                            $.ajax({
                                ...
                                processData: false,
                                success: (data) => {
                                    swal("Success", 'Hostel Updated successfully', 'success');
                                    console.log(data)
									window.location.reload();
                                ...
                                error: function(data) {
                                    console.log(data);
                                    swal("Oops!", 'Image size is too big', 'error');
                                }
                            });
                            });
                            });
                            ...
                            $("#update_project").on('submit', async function(e){
                ...
                $("#kt_modal_new_address_submit").attr('disabled',true)
                            ...
                            $.ajax({
                                ...
                                error: function(data) {
                                    console.log(data);
                                    swal("Oops!", 'Project Not Updated', 'error');
                                }
                            });
                            });
                ...
                $('body').on('click', '#upload_project_id', function () {
				var id = $(this).data('id');
               $("#project_id").val(id)
				// var id = $("#projectimage").val();
                  
				$.get('{{ route('loadprojectimages') }}?id=' + id, function (data) {
                    ...
                    $("#uploadedimagediv").append("<a style='position:absolute;background:red;display: inline-block;border:2px solid white;padding:5px;' class='deleteuploaded btn btn-danger btn-sm' data-id='"+data[i].id+"'>&times;</a><img class='imgpreview' style='width:100px;height:100px;margin:5px;box-shadow: 5px 5px 2px #888888' src='public/serviceimage/"+data[i].image+"'>")
        ...
        async function resetImage(el,id) {
                ...
                if (willUpdate) {
                    ...
                    swal("Image will not be deleted  :)");
                }
            }
                ...
                try {
                        ...
                        function (data, status) {
                            ...
                            if( status === "success") {
                                ...
                                let alert = swal('success',"Image successfully deleted!.",'success');
...
$.get('{{ route('edit.project') }}?id=' + id, function (data) {
    $('#ajax-crud-modal').modal('show');
     ...
     $('body').on('click', '#delete_hostel', function () {
        ...
        async function resetAccount(el,id) {
                ...
                if (willUpdate) {
                    ...
                    swal("Hostel will not be deleted  :)");
                }
            }
        ...
        function performDelete(el,id)
            {
                ...
                try {
                        ...
                        function (data, status) {
                            ...
                            console.table(data);
                            if( status === "success") {
                                let alert = swal('success',"Hostel successfully deleted!.",'success');
...
$('body').on('click', '#delete_project', function () {
        ...
        async function resetProject(el,id) {
                const willUpdate = await swal({
        ...
        function performDeleteProject(el,id)
            {
               
                try {
                        $.get('{{ route('destroy.project') }}?id=' + id,
                        function (data, status) {
                            console.log(status);
                            console.table(data);
                            if( status === "success") {
                                let alert = swal('success',"Project successfully deleted!.",'success');
                                $(el).closest( "tr" ).remove();
                                // alert.then(() => {
                                // });
                            }
    ...
    //  $(document).on('click', '.status_id', function () {
              ...
              $(".status_id").click(function() {
			    ...
			    $.get('{{ route('statusenable') }}?id=' + id, function (data) {
                  swal('Hostel Enabled','This hostel is now available for students','success') 
                // window.location.reload()
                });
                    ...
                    swal('Hostel Disabled','This hostel is no longer available for students','info') 
                    // window.location.reload()
                });
                }
            });
