...
{{-- //coming here --}}
<a href="#" class="btn btn-primary er fs-6 px-8 py-4 float-right" data-bs-toggle="modal" data-bs-target="#kt_modal_new_address">Create New Question</a>
        ...
        <table class="table align-middle gs-0 gy-4">
            ...
            <thead>
                <tr class="fw-bolder text-muted bg-light">
                    ...
                    <th class="ps-4 min-w-200px rounded-start">Test</th>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
                                    ...
                                    @for($i=0;$i<4;$i++)
                                    <input required type="radio" name="correct_answer" value="{{$i}}"><span>Is correct answer</span>
					<input type="text" name="options[]" class="form-control form-control-solid" placeholder=" options{{$i+1}}" required="" >
