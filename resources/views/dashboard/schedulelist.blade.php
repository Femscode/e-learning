    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div class='card' style='max-width:1200px'>
            <div class='card-header'>
                ...
                <div class="d-flex my-2 float-right">
                    <a href="/admincalendar" class="btn btn-info btn-sm">Schedule Calendar</a>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex my-2 float-left">
                    <a href="/schedule" class="btn btn-primary btn-sm">Create Schedule</a>
                </div>
                {{--
                    ...
                    <div class="row g-9 mb-8">
                        ...
                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                            ...
                            <select required name='user_id'
                                ...
                                data-select2-id="select2-data-10-v0xq" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                            <select rquired name='week' class="form-select form-select-solid select2-hidden-accessible"
                                data-control="select2" data-hide-search="true" data-placeholder="Select week"
                                name="target_assign" data-select2-id="select2-data-10-v0xq" tabindex="-1"
                                aria-hidden="true">
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id='scheduletable'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{date('F',strtotime($schedule->schedule_month)) }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="ms-2">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a id='mark_schedule' data-id="{{ $schedule->id }}"
                                                    data-name="{{ $schedule->schedule_title }}"
                                                    class="menu-link px-3">Mark Done</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a id='unmark_schedule' data-id="{{ $schedule->id }}"
                                                    data-name="{{ $schedule->schedule_title }}"
                                                    class="menu-link px-3">Unmark</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a id='delete_schedule' data-id="{{ $schedule->id }}"
                                                    data-name="{{ $schedule->schedule_title }}"
                                    ...
                                    {{-- <a id='mark_schedule' data-id="{{ $schedule->id }}"
                                        data-name="{{ $schedule->schedule_title }}" class='btn btn-success btn-sm'>Mark
                                        Done</a>
                                    <a id='unmark_schedule' data-id="{{ $schedule->id }}"
                                        data-name="{{ $schedule->schedule_title }}"
                                        class='btn btn-info btn-sm'>Unmark</a>
                                    <a id='delete_schedule' data-id="{{ $schedule->id }}"
                                        data-name="{{ $schedule->schedule_title }}"
                                    ...
                                    <div class="w-100">
                                                ...
                                                <span class="d-flex">
                                                    ...
                                                    <span class="ms-4">
                                                        <span class="fs-3 fw-bolder text-gray-900 mb-2 d-block">Team
                                                            Project</span>
                                                        <span class="fw-bold fs-4 text-muted">Create
                                                            corporate account to manage
                                                            users</span>
                                                    </span>
                                                    <!--end::Info-->
                                                </span>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button" class="btn btn-lg btn-primary"
                                                ...
                                                <span class="indicator-label">Project
                                                    Settings</span>
                                        ...
                                        <div class="fv-row mb-8">
                                            ...
                                            <div class="dropzone" id="kt_modal_create_project_settings_logo">
                                                ...
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="ms-4">
                                                        <h3 class="dfs-3 fw-bolder text-gray-900 mb-1">
                                                            Drop files here or click to upload.
                                                        </h3>
                                                        <span class="fw-bold fs-4 text-muted">Upload
                                                            up to 10 files</span>
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="ms-5">
                                                            <span
                                                                ...
                                                                Usage</span>
                                                            <span class="fw-bold fs-7 text-gray-600">Withdraw
                                            ...
                                            <div class="mh-300px scroll-y me-n7 pe-7">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-35px">
                                                            <img src="https://preview.Crown.com/metronic8/demo1/assets/media/svg/files/pdf.svg"
                                                                alt="icon" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Details-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="https://preview.Crown.com/metronic8/demo1/assets/media/svg/files/doc.svg"
                                                                alt="icon" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Details-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="https://preview.Crown.com/metronic8/demo1/assets/media/svg/files/css.svg"
                                                                alt="icon" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Details-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="https://preview.Crown.com/metronic8/demo1/assets/media/svg/files/ai.svg"
                                                                alt="icon" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Details-->
                                                ...
                                                <div class="d-flex flex-stack py-4">
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-35px">
                                                            <img src="https://preview.Crown.com/metronic8/demo1/assets/media/svg/files/tif.svg"
                                                                alt="icon" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Details-->
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="d-flex flex-center pb-20">
                                        <button type="button" class="btn btn-lg btn-light me-3"
                                            ...
                                            Deal</button>
                                        <a href="#" class="btn btn-lg btn-primary" data-bs-toggle="tooltip"
                                            title="Coming Soon">View
                                            Deal</a>
                                    </div>
                                    <!--end::Actions-->
                                    <!--begin::Illustration-->
                                    <div class="text-center px-4">
                                        <img src="../../../assets/media/illustrations/sketchy-1/20-dark.png" alt=""
