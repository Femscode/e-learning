...
function rgbToHex(rgb) {
    ...
    if (colors.length === 3) {
        let red = parseInt(colors[0].trim());
        let green = parseInt(colors[1].trim());
        let blue = parseInt(colors[2].trim());
...
function fullBitsHexColor(hexString) {
...
function darkenColor(color, percent) {
    ...
    if (color.length === 4 || color.length === 5 || color.length === 7 || color.length === 9) {
        if (color.length === 4) {//#FFF 
            ...
            if (isRGB === false) {
                return "#" + fullBitsHexColor(((tonedRed > 255 ? 255 : tonedRed).toString(16))) + fullBitsHexColor(((tonedGreen > 255 ? 255 : tonedGreen).toString(16))) +
                    fullBitsHexColor(((tonedBlue > 255 ? 255 : tonedBlue).toString(16)));
            } else {
            ...
            if (isRGB === false) {
                return "#" + fullBitsHexColor(((tonedRed > 255 ? 255 : tonedRed).toString(16))) + fullBitsHexColor(((tonedGreen > 255 ? 255 : tonedGreen).toString(16))) +
                    fullBitsHexColor(((tonedBlue > 255 ? 255 : tonedBlue).toString(16))) + fullBitsHexColor(((alpha > 255 ? 255 : alpha).toString(16)));
            } else {
